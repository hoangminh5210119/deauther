...
#define CH_TIME 200//140        /* Scan time (in ms) per channel */
#define PKT_RATE 5 /* Min. packets before it gets recognized as an attack */
#define PKT_TIME                                                               \
  1 /* Min. interval (CH_TIME*CH_RANGE) before it gets recognized as an attack \
     */
...
bool deauthStatus = false;
bool isDetectDeauther = false;
